...
import openpyxl
from app.models import clientes_imp, clientes_imp_filtrados, create_new_implementation, detail_MonthlySupport, detail_contact, detail_follow_up, detail_follow_update, detail_followU, list_follow_up, list_monthly_support, list_trains, list_users, new_company, new_train, obtener_info_clientes, obtener_info_clientes_contrato, obtener_info_clientes_filtrados, obtener_new_clientes, obtener_new_clientes_filtrados, register_follow_contact
...
def activeCompany():
    if request.method == 'POST':
        ...
        cursor.execute(
            "UPDATE company SET status_comp = TRUE WHERE ruc = %s", [ruc])
